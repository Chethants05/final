export const FooterLink2 = [
  {
    ...
    links: [
      { title: "Al", link: "/al" },
      { title: "Front-End Development", link: "/Front-End Development" },
      { title: "Back-End Development", link: "/Back-End Development" },
      { title: "Full-Stack Development", link: "/Full-Stack Development" },
      { title: "Javascript", link: "/Javascript" },
      { title: "Responsive Web Design", link: "/Responsive Web Design" },
      { title: "React Development", link: "/React Development" },
      { title: "API Development", link: "/API Development" },
